...
public class ConfigUtil {
    ...
    //for on error retry
    private final long onErrorRetryInterval = 1;//1 second
    private final TimeUnit onErrorRetryIntervalTimeUnit = TimeUnit.SECONDS;//1 second
    //for typed config cache of parser result, e.g. integer, double, long, etc.
    private long maxConfigCacheSize = 500;//500 cache key
    private final long configCacheExpireTime = 1;//1 minute
    private final TimeUnit configCacheExpireTimeUnit = TimeUnit.MINUTES;//1 minute
